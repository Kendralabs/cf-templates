...
ANSIBLE_PULL_URL = os.getenv('ANSIBLE_PULL_URL',
                             'https://github.com/Kendralabs/ansible-playbooks.git')
...
TEMPLATE.add_description('Kendra Fabric is open source software, optimized for '
                         'performance and security, that accelerates the creation of Cloud-native '
                         'applications driven by Big Data Analytics. Fabric makes it easier for '
...
TEMPLATE.add_mapping('Region2AMI', {
    ...
    EU_CENTRAL_1:   {'Ubuntu': 'ami-0767046d1677be5a0 ', 'RHEL': 'ami-009b16df9fcaac611'},     #updated ubuntu version to 20.04 LTS from Ubuntu 14.04.3 LTS
...
def user_data(resource):
    resource.UserData = Base64(Join('', [
        ...
        'set -e\n',
        '\n',
        #'curl -OsS https://bootstrap.pypa.io/get-pip.py\n',                                  # Ubuntu 20.04 has python 3.8 installed
        #'python get-pip.py -q\n',                                                            # All python commands are now python3 coz of python version
        'sudo apt update\n',                                                                  # Same goes for pip all pip commands are pip3
        'sudo apt-get install python3-pip\n',                                                 # To install pip use line 408 and 409
        '\n',
        # SEE: https://urllib3.readthedocs.org/en/latest/security.html#pyopenssl
        #'pip install -q pyopenssl ndg-httpsclient pyasn1\n',                                 # This is replaced by line 413
        'pip3 install ndg-httpsclient\n',                                                     # Provides enhanced HTTPS support for httplib and urllib2 using PyOpenSSL
        '\n',
        'DEBIAN_FRONTEND=noninteractive\n',
        '\n',
        #'apt-get -q update\n',                                                               # We dont need this line as we updating in line 408
        'sudo apt-get -qy install autoconf build-essential python-dev libffi-dev libssl-dev\n',
        '\n',
        'sudo apt install ansible\n',                                                         # To install ansible (2.9.6)
        '\n',
        'pip3 install https://s3.amazonaws.com/cloudformation-examples/aws-cfn-bootstrap-py3-latest.tar.gz\n', # Replace line 423 with 422
